...
export function TestObjects() {
  return (
    <>
      ...
      <RigidBody type="dynamic" colliders="cuboid" position={[0.2, TABLE_Y + 0.04, -0.1]}>
        <mesh>
      ...
      <RigidBody type="dynamic" colliders="ball" position={[0.4, TABLE_Y + 0.04, 0.1]}>
        <mesh>
      ...
      <RigidBody type="dynamic" colliders="hull" position={[0.5, TABLE_Y + 0.05, 0]}>
        <mesh>
